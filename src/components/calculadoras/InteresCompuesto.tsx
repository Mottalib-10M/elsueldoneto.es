...
export default function InteresCompuesto({ lang = 'es' }: { lang?: 'es' | 'en' }) {
  const l = lang === 'en';
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <div className="rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 p-6 text-center dark:from-blue-900/30 dark:to-blue-900/10">
          <p className="text-sm font-medium text-blue-600 dark:text-blue-400">{l ? 'Capital invested' : 'Capital invertido'}</p>

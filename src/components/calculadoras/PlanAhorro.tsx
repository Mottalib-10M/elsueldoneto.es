  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <CampoEntrada id="pa-aportacion" label="Aportación mensual" value={aportacion} onChange={setAportacion} min={0} max={100000} step={50} suffix="€/mes" />
        <CampoEntrada id="pa-tipo" label="Rentabilidad anual" value={tipo} onChange={setTipo} min={0} max={30} step={0.1} suffix="%" />
        <CampoEntrada id="pa-anios" label="Años" value={anios} onChange={setAnios} min={1} max={60} step={1} suffix="años" />
        <CampoEntrada id="pa-capital" label="Capital inicial" value={capitalInicial} onChange={setCapitalInicial} min={0} max={10000000} step={100} suffix="€" />
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <div className="rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 p-6 text-center dark:from-blue-900/30 dark:to-blue-900/10">
          <p className="text-sm font-medium text-blue-600 dark:text-blue-400">Total aportado</p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 dark:bg-gray-700">
                <th className="px-4 py-2 text-left font-medium text-gray-500">Año</th>
                <th className="px-4 py-2 text-right font-medium text-gray-500">Capital</th>
                <th className="px-4 py-2 text-right font-medium text-gray-500">Aportado</th>
                <th className="px-4 py-2 text-right font-medium text-gray-500">Intereses</th>
              </tr>
            </thead>
            <tbody>

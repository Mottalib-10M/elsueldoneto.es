  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-4 sm:grid-cols-3">
        <CampoSalario id="au-ingresos" label="Ingresos brutos" value={ingresos} onChange={setIngresos} min={0} max={500000} step={1000} />
        <CampoSalario id="au-gastos" label="Gastos deducibles" value={gastos} onChange={setGastos} min={0} max={300000} step={500} />
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <div className="rounded-xl bg-gradient-to-br from-emerald-50 to-emerald-100 p-6 text-center dark:from-emerald-900/30 dark:to-emerald-900/10">
          <p className="text-sm font-medium text-emerald-600 dark:text-emerald-400">Neto mensual</p>
        ...
        <div className="rounded-xl bg-gradient-to-br from-amber-50 to-amber-100 p-6 text-center dark:from-amber-900/30 dark:to-amber-900/10">
          <p className="text-sm font-medium text-amber-600 dark:text-amber-400">Cuota autónomos/mes</p>
        ...
        <div className="rounded-xl bg-gradient-to-br from-red-50 to-red-100 p-6 text-center dark:from-red-900/30 dark:to-red-900/10">
          <p className="text-sm font-medium text-red-600 dark:text-red-400">IRPF anual</p>
      ...
      <div className="overflow-hidden rounded-lg border border-gray-200 dark:border-gray-600">
        <table className="w-full text-sm">
          <tbody>
            ...
            <tr>
              <td className="px-4 py-2 font-medium text-gray-600 dark:text-gray-300">Neto anual</td>
